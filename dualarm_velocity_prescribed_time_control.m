function [t,Xd,Xo,FI,Fait,Vel,dXo,Ae,Tol]=dualarm_velocity_prescribed_time_control(dt,tstop,Tx,epsx,mo)
...
for i=0:1:tnum
    ...
    %根据设计的控制器求出轨迹与速度  
    [um,fait,ddxo,tol,Fe,dae]= practical_prescribed_time_controller(mo,Tx,epsx,DAom,xd,dxd,ts,Fic,Fi,q1,dq1,ddq1,q2,dq2,ddq2,x_hat2,xo,dxo,ae); %控制器
    ...
    t=[t;ts];   FI=[FI;Fi']; Fait=[Fait;fait];
    Vel=[Vel;x_hat2']; Ae=[Ae;ae];Tol=[Tol;tol'];
end
end
